  ...
  render() {
    return (
      <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" id="brand">WORKSPACE</a>
          <div  class="l-s">
            <Link to="/" class="btn btn-outline-primary mx-2"  data-toggle="modal" data-target="#loginModal">Login</Link>
            <Link to="/signup" class="btn btn-outline-primary" >Signup</Link>
          </div>
    </nav >
    );
  }
